...
class cpanel extends Controller
{
    ...
    function create_appointment()
    {
        ...
        $this->view->d = array('servicescategory'=> $this->model->get_services(),
         ...
         $this->view->render('create_appointment', 'admin' ,true);
    }
    function cpanel()
    {
    ...
    function appointments($q)
    {
        ...
        $this->view->total = array
                            (
                                't_today' => $this->model->admin_custom_query("SELECT count(*) from `booking` where AppointmentDate ='$date' "),
                                't_today_c' => $this->model->admin_custom_query("SELECT count(*) from `booking` where AppointmentDate ='$date' and Status='Cancelled' "),
                                't_today_f' => $this->model->admin_custom_query("SELECT count(*) from `booking` where AppointmentDate ='$date' and Status='Finished' "),
                                't_month' => $this->model->admin_custom_query(" SELECT count(*) FROM booking where AppointmentDate >= '$dateMinusMonth' and  AppointmentDate <= '$date'"),
                                't_month_f' => $this->model->admin_custom_query(" SELECT count(*) FROM booking where AppointmentDate >= '$dateMinusMonth' and AppointmentDate <= '$date' and Status = 'Finished'"),
                                't_month_c' => $this->model->admin_custom_query(" SELECT count(*) FROM booking where AppointmentDate >= '$dateMinusMonth' and AppointmentDate <= '$date' and Status = 'Cancelled'")
                            );
