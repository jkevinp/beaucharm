  ...
  <div id="main">
      <div class="col-md-12">
          ...
          <div>
            <table class="table table-responsive table-hover">
                <tr> 
                  <td>Total Transactions Today</td>
                  <td><?php echo $this->total['t_today'][0]['count(*)'];?> </td>
                </tr>
                <tr> 
                  <td>Total Cancelled Transactions Today</td>
                  <td><?php echo $this->total['t_today_c'][0]['count(*)'];?> </td>
                </tr>
                <tr> 
                  <td>Total Finished Transactions Today</td>
                  <td><?php echo $this->total['t_today_f'][0]['count(*)'];?>  </td>
                </tr>
                <tr> 
                  <td>Total Transactions For this month</td>
                  <td><?php echo $this->total['t_month'][0]['count(*)'];?>  </td>
                </tr>
                <tr> 
                  <td>Total Cancelled Transactions this month</td>
                  <td> <?php echo $this->total['t_month_c'][0]['count(*)'];?> </td>
                </tr>
                <tr> 
                  <td>Total Finished Transactions this month</td>
                  <td> <?php echo $this->total['t_month_f'][0]['count(*)'];?> </td>
                </tr>
            </table>
